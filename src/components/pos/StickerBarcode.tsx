...
export function StickerBarcode({ value, heightMm = 5.8 }: { value: string; heightMm?: number }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label={`Barcode ${value}`}
      ...
      style={{ display: "block", width: `${encoding.widthMm}mm`, minWidth: `${encoding.widthMm}mm`, maxWidth: "none", height: `${heightMm}mm`, flexShrink: 0, margin: "0 auto" }}>
